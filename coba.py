...
Original file is located at
    https://colab.research.google.com/drive/1EGn-qc9VABdPSarW4msrs9n720HbqoWc
"""
...
with data_set_description:
    st.write("Moh. Iqbal Baihaki        200411100004")
    st.write("Achmad Arga Bimantara A   200411100137")
    st.write("Citra Indah Lestari       200411100202")
    ...
    """)
    st.write("Link Dataset pada Repository UCI : https://archive.ics.uci.edu/dataset/225/ilpd+indian+liver+patient+dataset")
...
with implementation:
    with st.form("my_form"):
        ...
        model = st.selectbox('Pilihlah model yang akan anda gunakan untuk melakukan prediksi?',
              ('Gaussian Naive Bayes','Gaussian Naive Bayes','Gaussian Naive Bayes'))
